...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/election-management-system
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/election-management-system_test
```
